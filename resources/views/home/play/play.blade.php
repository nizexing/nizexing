...
<head>
    ...
    <meta name="keywords" content="凯文先生《结果》非洲鼓丽江手鼓音乐演奏表演,A站,ACFUN,ACG,弹幕" />
    <meta name="description" content="凯文先生《结果》非洲鼓丽江手鼓音乐演奏表演,A站,ACFUN,ACG,弹幕,视频,动画,漫画,游戏,斗鱼,新番,鬼畜,东方,初音,DOTA,MUGEN,LOL,Vocaloid,MAD,AMV,天下漫友是一家" />
    ...
    <nav id="nav" class="wp nav">
        <div class="clearfix wp nav-parent">
            ...
            <ol id="header-guide" class="fr header-guide">
                <li class="guide-item guide-user"> <a href="http://www.acfun.cn/member/" target="_blank" class="user-avatar item"> <img src="picture/avatar.jpg" width="30" height="30" /></a> <a href="http://www.acfun.cn/login/" target="_blank" class="item user-login">登录/注册</a> <span class="user-message-count hidden"></span>
...
<div id="main" class="main">
    <section class="clearfix wp area head">
        <script>var pageInfo = {
                "commentCount": 0,
                "link": "",
                "description": "感谢亲们点赞，转发，评论 凯文每天将在点赞，转发，评论的小伙伴中随机抽出幸运小伙伴送一副凯文的亲笔签名鼓棒。 ",
                "channelPath": "v",
                "title": "凯文先生《结果》非洲鼓丽江手鼓音乐演奏表演",
                "duration": 263,
                "bananaCount": 0,
                "tagList": [{
                    "name": "演奏",
                ...
                "favoriteCount": 0,
                "id": 3812129,
                "coverImage": "http://imgs.aixifan.com/content/2017_06_27/1498537345.jpg",
                "contributeTime": "2017-06-27 12:24",
                "bfdContributeTimenew": "2017年 6月27日(EEE) H时24分",
                "userAvatar": "http://cdn.aixifan.com/dotnet/20120923/style/image/avatar.jpg",
                "isTudouDomain": false,
                "isArticle": false,
                "isViewOnly": false,
                "isEssense": false,
                ...
                "parentChannelId": 58,
                "parentChannelName": "音乐",
                "channelName": "演奏",
                "latestCommentTime": 1498537443000,
                "isRecommended": false,
                "isTopLevel": false,
                "userId": 12138573,
                "verified": 0,
        ...
        <div class="crumbs">
            <div id="bd_crumb" class="fl">
                ...
                <!--坑爹的百分点-->
                <span class="time hidden">2017年 6月27日(EEE) H时24分</span>
                <span class="time">2017-06-27 12:24</span>
                <span data-uname="凯文先生在路上" data-type="投稿" data-oid="3812129" data-proof="凯文先生《结果》非洲鼓丽江手鼓音乐演奏表演" class="sp7">举报视频</span>
            </div>
            <div class="fr">
    ...
    <section class="clearfix wp area crumb">
     ...
     <div class="div-banana">
      ...
      <span class="text fl">喂 <span>凯文先生在路上</span>食&nbsp;0&nbsp;香蕉</span>
     </div>
        ...
        <section class="clearfix wp area">
            <div class="columen-left fl">
                ...
                <div class="desc gheight">
                    <div class="sp1">
                        感谢亲们点赞，转发，评论 凯文每天将在点赞，转发，评论的小伙伴中随机抽出幸运小伙伴送一副凯文的亲笔签名鼓棒。&nbsp;
                    </div>
            ...
            <div class="column-right fr">
                ...
                <div data-uid="12138573" class="user">
                    <a href="/u/12138573.aspx" target="_blank" id="bd_uphead" class="a1">
                        <div class="backg"></div> <img src="picture/avatar.jpg" class="avatar" />
                    ...
                    <div class="tool">
                        <span id="bd_follow" data-status="0" data-name="凯文先生在路上" data-userid="12138573" class="fl flow">+&nbsp;关注</span>
                        <a href="/member/#area=mail-new;username=凯文先生在路上;" target="_blank" id="bd_letter" class="fl letter">私信</a>
                    </div>
                </div>
                <div class="bottom">
                    <div class="desc">
        ...
        <section class="clearfix wp area comm">
            ...
            <div class="columen-right fr">
                ...
                <div id="temp-recom-view" class="hidden">
                    <li class="has-img"> <a href="[link]" title="[title]" target="_blank" class="fl img-wp">[img]</a> <b> <a href="[link]" title="[title]" target="_blank">[title]</a></b> <p class="text-overflow"> <a href="[userurl]" target="_blank" title="[username]">UP: [username]</a></p> <p> <span class="icon icon-view-player"> <strong>[view]</strong></span> <span class="icon icon-comments"> <strong>[comm]</strong></span> </p> </li>
                </div>
            </div>
        </section>
    </div>
...
<div id="footer" class="footer">
    <div class="wp footer-con">
        <div class="clearfix footer-top">
            <div class="fl footer-nav">
                ...
                <div class="item-official">
                    <h5>官方</h5>
                    <p> <a href="http://weibo.com/danmushipin/" target="_blank">新浪微博</a> <a href="http://tb.am/cbaz8/" target="_blank" class="mr0">官方网店</a> <br /> <a href="/gamecenter" target="_blank" data-id="1" class="gamePortal">游戏中心</a> <a class="i-o-ewm"> <span class="i-o-code"> <img src="picture/erweima.jpg" /></span>微信公众号</a> </p>
                </div>
        ...
        <div class="footer-bottom">
            <a href="http://www.acfun.cn"> <img src="picture/logo-gray.png" width="78" height="24" /></a>
...
<div id="pop-login" style="display:none" class="pop">
    <div class="login-logo">
        <img src="picture/area-login.png" />
    </div>
...
<script src="js/ubb.min.js"></script>
<script src="js/comm.min.js"></script>
<script src="js/swfobject.min.js"></script>
<script src="js/detail.min.js"></script>
<script>var _hmt = _hmt || []; (function() {
        var hm = document.createElement("script");
        hm.src = "//hm.baidu.com/hm.js?bc75b9260fe72ee13356c664daa5568c";
