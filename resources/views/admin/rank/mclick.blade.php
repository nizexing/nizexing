...
@section('content')
        ...
        <div class="result_wrap" style="width:1024px;margin:60px 0px 0px 200px">
            ...
            <a href="{{ asset('/rank/click/d') }}"><button type="button" class="btn btn-info">日排行榜</button></a>
            <a href="{{ asset('/rank/click/w') }}"><button type="button" class="btn btn-info">周排行榜</button></a>
            <a href="{{ asset('/rank/click/m') }}"><button type="button" class="btn btn-info" style="background-color: red">月排行榜</button></a> 
            <br>
